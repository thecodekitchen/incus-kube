...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/pulumi/pulumi-terraform-provider/sdks/go/incus/incus(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2x4Yy9pbmN1cyIsInZlcnNpb24iOiIxLjAuMCJ9fQ==")
		if err != nil {
			return "", err
		}
